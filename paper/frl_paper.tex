...
differential Friday concentration in this sample.  A causal claim would
require (a)~a larger UCITS control panel via direct issuer-page NAV
downloads or (b)~a synthetic-control construction using non-bond
benchmarks; both are outlined in Appendix~E.5.
\end{tablenotes}
\end{threeparttable}
\end{table}
