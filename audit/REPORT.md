...
| GREEN | `abs_rho_aum` | abstract | -0.1200 | -0.1176 | 0.0024 | abs 0.05 | HARD | output/spearman_predictors.json:log_aum/rho |
| GREEN | `abs_rho_treasury` | abstract | 0.5000 | 0.5040 | 0.0040 | abs 0.05 | HARD | output/spearman_predictors.json:treasury/rho |
...
| GREEN | `s53_rho_aum` | section_5_3_spearman | -0.1200 | -0.1176 | 0.0024 | abs 0.05 | HARD | output/spearman_predictors.json:log_aum/rho |
| GREEN | `s53_rho_treasury` | section_5_3_spearman | 0.5000 | 0.5040 | 0.0040 | abs 0.05 | HARD | output/spearman_predictors.json:treasury/rho |
| GREEN | `s53_rho_advaum` | section_5_3_spearman | 0.1600 | 0.1618 | 0.0018 | abs 0.05 | HARD | output/spearman_predictors.json:log_advaum/rho |
| GREEN | `s53_rho_expense` | section_5_3_spearman | 0.0600 | 0.0617 | 0.0017 | abs 0.05 | HARD | output/spearman_predictors.json:expense/rho |
| GREEN | `s53_wald_F_flow` | section_5_3_spearman | 1.5700 | 1.5657 | 0.0043 | abs 0.4 | HARD | output/cross_sectional_diag.json:wald_F_flow |
